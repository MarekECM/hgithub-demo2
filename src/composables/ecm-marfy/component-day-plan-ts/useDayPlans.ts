...
async function addDayPlanFormSubmit(data: DayPlanModel, formData: DynamicFormData, toast: ReturnType<typeof useToast>) {
  ...
  try {
    ...
    toast.add({ severity: 'success', summary: 'Úspěch', detail: 'Denní plán byl vytvořen', life: 3000 })
  } catch (e: any) {
    console.error('Chyba při vytváření denního plánu:', e)
    toast.add({ severity: 'error', summary: 'Chyba', detail: `Denní plán nebyl vytvořen: ${e.message}`, life: 3000 })
  }
}
