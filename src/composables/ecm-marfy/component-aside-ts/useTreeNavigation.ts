  ...
  function renderTree(nodes: any[], isRoot = false): any {
    ...
    return nodes.map((node) => {
      ...
      return h('li', { class: 'ecm-aside__nav-tree-main-item', key: node.id }, [
        h(
          'details',
          { class: 'ecm-aside__nav-tree-main-details', ref: detailsRef, open: isExpanded },
          [
            h(
              'summary',
              {
                class: 'ecm-aside__nav-tree-summary-container',
              ...
              [
                h(
                  ...
                  {
                    class: [
                      'ecm-aside__item-tree-wrap-2',
                      store.selectedNodeId === node.id ? 'aside-navbar-active-link' : ''
                    ].join(' ')
                  },
                  [
                      ...
                      ? h(
                          ...
                          [
                            h(
                              'span',
                              {
                                class: 'material-icons ecm-aside__arrow-icon ecm-aside__arrow',
                                ref: arrowRef,
                    ...
                    h(
                      ...
                      [
                        ...
                        h(
                          'span',
                          {
                            class: 'ecm-aside__nav-tree-text-content ',
