...
import alarmsTable from '@/components/ecm-marfy-components/components-alarms/alarmsTableComponent.vue'
    ...
    <section class="mainContentContainer" style="padding-top: 110px">
      <div class="activeDevicesContainer">
        <div class="titleDevices DataPageTitle">
          <span class="ecm_alarmsTitle">Dalovice</span>
...
.ecm_selectionAlarms {
  width: 180px;
  height: 35px;
  background-color: var(--btnBgSelectAlarms);
  border-radius: 5px;
  font-size: 16px;
  display: flex;
  align-items: center;
  ...
  padding: 10px;
  cursor: pointer;
  border: 1px solid var(--btnBorderAlarms);
  transition: var(--transtion3);
}

.ecm_selectionPeriodsText {
  width: 100%;
}

.ecm_selectionAlarms .iconContent {
  padding: 0;
}
</style>
