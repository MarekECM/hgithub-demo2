...
import { fetchAndStoreDevices } from '@/composables/ecm-marfy/componenet-devices/data/fetchDevices'
...
import sectionBanner from '@/components/ecm-marfy-components/components-sections/section-banner-component.vue'
import productionSection from '@/components/ecm-marfy-components/components-sections/production-section-component.vue'
import consumptionSection from '@/components/ecm-marfy-components/components-sections/consumption-section-component.vue'
import economicPerformanceComponent from '@/components/ecm-marfy-components/components-sections/economic-performance-component.vue'
  ...
  <main class="ecm-main" :style="sidebarStore.dynamicStyles">
    <div class="ecm-main__wrap">
      ...
      <section class="ecm-main__container-secondary">
        <div class="ecm-main__title-devices">Vaše aktivní zařízení</div>
